...
#include "codegen/graph/input.hpp"
#include "codegen/graph/output.hpp"

#include "codegen/IR/attribute.hpp"
namespace codegen
{
    namespace graph
    {
        ...
        struct GNodeIndex
        {
            ...
            const codegen::Shape& get_shape() const;
            const codegen::element::Type& get_element_type() const;
            std::shared_ptr<codegen::graph::GNode> gnode;
            int index;
        };
        ...
        class GNode : public std::enable_shared_from_this<GNode>, public codegen::ir::Tagable
        {
        public:
            GNode();
            ...
            /// in edges
            std::vector<std::shared_ptr<codegen::graph::Edge>> get_in_edges() const;
            const std::shared_ptr<codegen::graph::Edge> get_in_edge(size_t i) const;

            void add_in_edge(std::shared_ptr<codegen::graph::Edge> edge);
            void remove_in_edge(std::shared_ptr<codegen::graph::Edge> edge);

            ///  out edges
            std::vector<std::shared_ptr<codegen::graph::Edge>> get_out_edges() const;
            std::vector<std::shared_ptr<codegen::graph::Edge>> get_output_users(size_t i);

            void add_out_edge(std::shared_ptr<codegen::graph::Edge> edge);
            void remove_out_edge(std::shared_ptr<codegen::graph::Edge> edge);
            ...
            codegen::descriptor::Tensor& get_input_tensor(size_t i) const;
            /// Returns the tensor view of input i
            std::shared_ptr<codegen::descriptor::Tensor> get_input_tensor_ptr(size_t i) const;
            ...
            codegen::descriptor::Tensor& get_output_tensor(size_t i) const;
            /// Returns the tensor view of output i
            std::shared_ptr<codegen::descriptor::Tensor> get_output_tensor_ptr(size_t i) const;
            ...
            const codegen::element::Type& get_output_element_type(size_t i) const;

            /// Returns the shape for output i
            const codegen::Shape& get_output_shape(size_t i) const;

            /// Returns the partial shape for output i
            const codegen::PartialShape& get_output_partial_shape(size_t i) const;

            /// Returns the element type of input i
            const codegen::element::Type& get_input_element_type(size_t i) const;

            /// Returns the shape of input i
            const codegen::Shape& get_input_shape(size_t i) const;

            /// Returns the partial shape of input i
            const codegen::PartialShape& get_input_partial_shape(size_t i) const;
        ...
        public:
            ...
            std::vector<std::shared_ptr<codegen::descriptor::Tensor>> inputs;
            std::vector<std::shared_ptr<codegen::descriptor::Tensor>> outputs;
        };
