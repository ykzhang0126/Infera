...
namespace codegen
{
    namespace ir
    {
        ...
        private:
            ...
            vector<shared_ptr<codegen::descriptor::Tensor>> inputs;
            // The output tensor ptr
            vector<shared_ptr<codegen::descriptor::Tensor>> outputs;
            // The tmp tensor ptr
            vector<shared_ptr<codegen::descriptor::Tensor>> internal_tensors;
        ...
        public:
            ...
            vector<shared_ptr<codegen::descriptor::Tensor>>& get_inputs();
            vector<shared_ptr<codegen::descriptor::Tensor>>& get_outputs();
            vector<shared_ptr<codegen::descriptor::Tensor>>& get_internal_tensors();
