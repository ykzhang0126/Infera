...
namespace codegen
{
    namespace ir
    {
        ...
        //using TensorAttr = ScalarAttributeValue<codegen::TensorWrapper>;
        //using TensorsAttr = VectorAttributeValue<codegen::TensorWrapper>;
...
#undef CREATE_ACCESSOR
        ...
        protected:
            ...
            typename T::ValueType& get(Symbol name) const
            {
                ...
                codegen_CHECK(child->check_type())
            ...
            iterator find(Symbol name, bool required)
            {
                ...
                codegen_CHECK(!required || it != values_.end()) << "The attribute is not existed.";
                return it;
            }
            ...
            const_iterator find(Symbol name, bool required) const
            {
                ...
                codegen_CHECK(!required || it != values_.end()) << "required undefined attribute:"
                                                                 << name;
                return it;
            }
        };
        ...
        public:
            ...
            {
                codegen_CHECK_NOT_NULLPTR(_tags);
            ...
            T& as()
            {
                codegen_CHECK(is_valid()) << "Tag doesn't have item who's name is: " << _sym
                                           << ".";
        ...
        template <>
        void codegen::ir::TagProxy::operator=<char*>(char* str);
        template <>
        void codegen::ir::TagProxy::operator=<char[]>(char str[]);
        template <>
